...
```bash
./scripts/build_release.sh 0.9.12
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.9.12_share.zip`
- `MoveFolders_v0.9.12_installer.pkg`
