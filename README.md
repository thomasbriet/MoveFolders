...
```bash
./scripts/build_release.sh 0.9.7
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.9.7_share.zip`
- `MoveFolders_v0.9.7_installer.pkg`
