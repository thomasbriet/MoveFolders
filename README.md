...
```bash
./scripts/build_release.sh 0.8.2
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.8.2_share.zip`
- `MoveFolders_v0.8.2_installer.pkg`
...
Publiceer nieuwe installers als GitHub Release assets, bijvoorbeeld met tag `v0.8.2`, `v0.8.3`, enzovoort.
