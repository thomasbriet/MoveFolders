...
```bash
./scripts/build_release.sh 0.8.1
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.8.1_share.zip`
- `MoveFolders_v0.8.1_installer.pkg`
...
Publiceer nieuwe installers als GitHub Release assets, bijvoorbeeld met tag `v0.8.1`, `v0.8.2`, enzovoort.
