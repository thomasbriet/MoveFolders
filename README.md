...
```bash
./scripts/build_release.sh 0.6.3
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.6.3_share.zip`
- `MoveFolders_v0.6.3_installer.pkg`
...
Publiceer nieuwe installers als GitHub Release assets, bijvoorbeeld met tag `v0.6.3`, `v0.6.4`, enzovoort.
