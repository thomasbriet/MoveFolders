...
```bash
./scripts/build_release.sh 0.6
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.6_share.zip`
- `MoveFolders_v0.6_installer.pkg`
...
Publiceer nieuwe installers als GitHub Release assets, bijvoorbeeld met tag `v0.6`, `v0.7`, enzovoort.
