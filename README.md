...
```bash
./scripts/build_release.sh 0.8.9
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.8.9_share.zip`
- `MoveFolders_v0.8.9_installer.pkg`
