...
```bash
./scripts/build_release.sh 0.9.16
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.9.16_share.zip`
- `MoveFolders_v0.9.16_installer.pkg`
