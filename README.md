...
```bash
./scripts/build_release.sh 0.9.19
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.9.19_share.zip`
- `MoveFolders_v0.9.19_installer.pkg`
