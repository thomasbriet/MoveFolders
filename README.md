...
```bash
./scripts/build_release.sh 0.9.26
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.9.26_share.zip`
- `MoveFolders_v0.9.26_installer.pkg`
