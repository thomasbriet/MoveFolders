...
```bash
./scripts/build_release.sh 0.9.13
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.9.13_share.zip`
- `MoveFolders_v0.9.13_installer.pkg`
