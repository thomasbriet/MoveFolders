...
```bash
./scripts/build_release.sh 0.9.6
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.9.6_share.zip`
- `MoveFolders_v0.9.6_installer.pkg`
