...
```bash
./scripts/build_release.sh 0.7
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.7_share.zip`
- `MoveFolders_v0.7_installer.pkg`
...
Publiceer nieuwe installers als GitHub Release assets, bijvoorbeeld met tag `v0.7`, `v0.7.1`, enzovoort.
