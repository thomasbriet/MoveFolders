...
```bash
./scripts/build_release.sh 0.9.28
```

Dit maakt lokaal:

- `MoveFolders.app`
- `MoveFolders_v0.9.28_share.zip`
- `MoveFolders_v0.9.28_installer.pkg`
